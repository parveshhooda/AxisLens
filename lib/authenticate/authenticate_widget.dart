                      ...
                      child: FutureBuilder<List<UserRecord>>(
                        future: queryUserRecordOnce(
                          queryBuilder: (userRecord) => userRecord.where(
                              'employee-id',
                              isEqualTo: widget.empId?.toString()),
                          singleRecord: true,
                        ),
                        builder: (context, snapshot) {
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: 'Answer Your Security Question',
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                    hintText: 'Answer Your Security Question',
                              ...
                              if (FFAppState().wrongAttemptFlag)
                                Align(
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 5.0, 0.0, 0.0),
                                    child: Text(
                                      'Your account has been locked, kindly contact admin',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Lato',
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      if (functions.toUpperCase(
                                        ...
                                        setState(() {
                                          FFAppState().wrongAttemptFlag = true;
                                        });
                                        return;
                                      }
                                    },
