...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF97144D);
  late Color secondary = const Color(0xFFED1164);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFF282828);
  late Color secondaryText = const Color(0xFF6E6E6E);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF616161);
  late Color accent2 = const Color(0xFF757575);
  late Color accent3 = const Color(0xFFE0E0E0);
  late Color accent4 = const Color(0xFFCFEAF8);
  late Color success = const Color(0xFF1FC24E);
  late Color warning = const Color(0xFFFEC600);
  late Color error = const Color(0xFFFF2121);
  late Color info = const Color(0xFF145599);

  late Color primaryBtnText = Color(0xFFFFFFFF);
  late Color lineColor = Color(0xFFF1F1F1);
}
