...
class _LeadboardWidgetState extends State<LeadboardWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        FFAppState().LeaderboardBlurr = true;
      });
      await Future.delayed(const Duration(milliseconds: 6000));
      setState(() {
        FFAppState().LeaderboardBlurr = false;
      });
      ...
      body: SafeArea(
        ...
        child: Stack(
          children: [
                                        ...
                                        child: FutureBuilder<List<UserRecord>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<UserRecord>
                                                ...
                                                snapshot.data!;
                                            if (transactionListUserRecordList
                                                .isEmpty) {
                                              return Center(
                                                child: Image.asset(
                                                                  ...
                                                                  Text(
                                                                    valueOrDefault<
                                                                      ...
                                                                      widget.usernamePassedFromDashboard ==
                                                                              transactionListUserRecord.userName
                                                                          ? 'You'
                                                                          : transactionListUserRecord.userName,
                                                                      'Unknown',
                                                                    ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Align(
                              alignment: AlignmentDirectional(0.0, 0.0),
                              child: Lottie.asset(
                                'assets/lottie_animations/88581-winners-lottie-animation.json',
                                width: 100.0,
                                height: 150.0,
                                fit: BoxFit.cover,
                                animate: true,
            ...
            if (FFAppState().LeaderboardBlurr)
              Align(
                alignment: AlignmentDirectional(0.0, 0.0),
                child: wrapWithModel(
                  model: _model.leaderboardBufferModel,
                  updateCallback: () => setState(() {}),
                  child: LeaderboardBufferWidget(),
                ),
              ),
          ],
        ),
